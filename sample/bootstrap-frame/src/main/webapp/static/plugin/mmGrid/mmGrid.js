...
!function($){
    ...
    MMGrid.prototype = {
        ...
        _initLayout: function($el){
            ...
            if(opts.checkCol){
                var chkHtml = opts.multiSelect ?  '<input type="checkbox" class="checkAll ace ace-checkbox-1" ><label for="" class="lbl"></label>'
                    : '<input type="checkbox" disabled="disabled" class="checkAll ace ace-checkbox-1"><label for="" class="lbl"></label>';
